...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const adminEmails = ['ats_admin@gmail.com', 'admin@housenama.com'];
  ...
  return (
    <div className="login-container">
      <div className="login-box">
        <h2>Admin Login</h2>
        <p className="login-note">Use: <strong>ats_admin@gmail.com</strong></p>
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input
              type="email"
              placeholder="ats_admin@gmail.com"
